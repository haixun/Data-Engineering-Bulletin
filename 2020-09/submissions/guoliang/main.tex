...
%\input{submissions_new/guoliang/commands}
%\input{commands}
%!TEX root = main.tex
\newcommand{\eat}[1]{}
...
\input{submissions_new/guoliang/sections/abstract}
\input{submissions_new/guoliang/sections/introduction}
\input{submissions_new/guoliang/sections/dataprep}
\input{submissions_new/guoliang/sections/system}
\input{submissions_new/guoliang/sections/descriptive}
\input{submissions_new/guoliang/sections/diagnostic}
\input{submissions_new/guoliang/sections/perspective}
\input{submissions_new/guoliang/sections/conclusions}
