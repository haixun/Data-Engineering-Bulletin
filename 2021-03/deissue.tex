...
\begin{opinion}{ML-In-Databases: Assessment and Prognosis}
{Tim Kraska, Umar Farooq Minhas, Thomas Neumann, Olga Papaemmanouil, Jignesh M. Patel, Chris R\' e, Michael Stonebraker}{}
\input{letters/opinion.tex}
\end{opinion}
\end{opinionsection}
...
\input{submissions/continuous-pipelines/main.tex}
\end{article}
...
\input{submissions/data-validation-amazon/data-validation-ml-systems.tex}
\end{article}
