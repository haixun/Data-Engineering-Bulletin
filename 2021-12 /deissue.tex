...
\usepackage{debulletin,times,epsfig,subfigure,wrapfig,algorithmic,color,boxedminipage,url}
...
\input{submissions/McDonald_final/AI-Enhanced_AATs_Main.tex}
\end{article}
...
\input{submissions/Wortman_final/main-final.tex}
\end{article}
%
%\makeatletter
%\renewcommand{\AB@affillist}{}
...
\input{submissions/Woodruff_final/AIsurvey15country.tex}
\end{article}
%
%\makeatletter
%\renewcommand{\AB@affillist}{}
...
\input{submissions/Richards_final/FactSheets.tex}
\end{article}
%
%\makeatletter
%\renewcommand{\AB@affillist}{}
...
\input{submissions/Feldman_final/ethics_rules_of_engagement_and_ai.tex}
\end{article}
