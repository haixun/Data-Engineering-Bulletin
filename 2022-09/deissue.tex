...
\input{submissions/eda-survey-peng/main}
\end{article}
...
\input{submissions/workflow-vizier-glavic/2022_IEEE_DEB_Vizier}
\end{article}
...
\input{letters/joy-award.tex}
\end{award}
\newpage
\begin{award}{Letter from the Rising Star Award Winner}
{Leilani Battle}{University of Washington, USA}
\input{letters/battle-award.tex}
\end{award}
\end{awardsection}
