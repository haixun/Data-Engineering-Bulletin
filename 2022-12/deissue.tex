...
\input{submissions/logical-queries-survey/main.tex}
\end{article}
...
\input{submissions/logical-queries-uiuc/main.tex}
\end{article}
...
%\input{submissions/industrial-kg/deissue.tex}
%\end{article}
...
\input{submissions/reasoning-nlp/main.tex}
\end{article}
...
%\graphicspath{{submissions/NobleRoberts_final/}}
\input{submissions/kbqa-colledge/main.tex}
\end{article}
...
\input{submissions/knowledge-sentiment-analysis/main.tex}
\end{article}
...
\input{submissions/HyCLID/main.tex}
\end{article}
...
\input{submissions/causal-meta-knowledge/main.tex}
\end{article}
