...
\input{letters/murat-welcome.tex}
\end{letter}
%
\newpage
...
\input{letters/murat-opinion.tex}
\end{opinion}
\end{opinionsection}
...
\input{submissions/LeyeWang/fed_truth_finder.tex}
\end{article}
...
\input{submissions/ManiMalek/main.tex}
\end{article}
...
\input{submissions/XueyangWu/main.tex}
\end{article}
...
Mona Flores, and
Andrew Feng}
\input{submissions/HolgerRoth/main.tex}
\end{article}
\newpage
...
{Kyu-Young Whang, Marianne Winslett}{Distinguished Professor Emeritus, KAIST\\ Research Professor Emerita, University of Illinois at Urbana-Champaign\\ together with Gio’s other former students}
\input{letters/obituary.tex}
\end{news}
