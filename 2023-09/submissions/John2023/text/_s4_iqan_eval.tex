...
\begin{figure*}
    \centering
    \includegraphics[width=0.98\textwidth]{figures/eva_runtime_Skylake}
...
\begin{minipage}[t]{0.55\textwidth}
    \centering
    \includegraphics[width=0.98\textwidth]{figures/eva_runtime_recall-1_KNL}
...
\begin{minipage}[t]{0.42\textwidth}
    \centering
    \includegraphics[width=0.98\textwidth]{figures/eva_sift1b_deep1b_latency}
