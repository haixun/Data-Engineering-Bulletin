...
\input{letters/opinion-david.tex}
\end{opinion}
\begin{opinion}{The Ubiquity of Subjectivity}
{Alon Halevy}{}
\input{letters/opinion-alon.tex}
\end{opinion}
\end{opinionsection}
...
\input{submissions/snoll/2019_de_bull_march_noll_hrm.tex}
\end{article}
%
\begin{article}
...
\input{submissions/mwei/paper.tex}
\end{article}
...
\input{submissions/jgiceva/main.tex}
\end{article}
...
\input{submissions/zistvan/fpgadb.tex}
\end{article}
...
\input{submissions/ptozun/PTdebullMarch.tex}
\end{article}
...
\input{submissions/vleis/main.tex}
\end{article}
\end{articlesection}
