...
\begin{figure}
\centering	
\subfloat[\label{fig:1a}]{\includegraphics[width=0.6\textwidth]{adaptability_results}}
\hfill
\subfloat[\label{fig:1b}]{
%\begin{minipage}[b]{.5\linewidth}
%\centering 
%\includegraphics[width=\textwidth]{adaptability_results}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.55\textwidth]{PR_scale_out.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.7\textwidth]{active-hw-everywhere-crop.pdf}
